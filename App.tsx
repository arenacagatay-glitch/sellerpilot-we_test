                   ...
                   {card.id === 1 && (
                     <div className="w-full h-full flex flex-col font-sans text-xs relative bg-white">
                       <div className="p-3 bg-white border-b border-gray-200 flex gap-3 items-center">
                         <div className="w-10 h-10 bg-orange-400 rounded blur-[2px]"></div>
                         <div className="flex-1">
    ...
    <section className="py-24 bg-gradient-to-br from-orange-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl text-dark-gray mb-12 max-w-2xl mx-auto">
          Kredi kartı gerekmez. Hemen kayıt olun, API bilgilerinizi girin ve SellerPilot müşteri sorularınızı otomatik cevaplamaya başlasın.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:pl-12">
            ...
            <ul className="space-y-4">
              ...
              <li><a href="https://app.sellerpilot.cloud" className="text-gray-400 hover:text-primary transition-colors">Ücretsiz Dene</a></li>
            </ul>
          </div>
