...
export const POSTS_2: BlogPost[] = [
  {
    ...
    content:
      ...
      'Bir de işin görünmeyen tarafı var: verdiğiniz cevabı yalnızca soruyu soran kişi okumaz. Ürün sayfasına gelen diğer müşteriler de o soru-cevap geçmişini görür. Yani stokta yok deyip kestirip attığınız her cevap, sonradan gelen onlarca müşteriye de mağazanızın çözüm üretmediğini söyler. Alternatif öneren bir cevap ise aynı kalabalığa tam tersini anlatır: bu mağaza müşterisini boş çevirmiyor.\n\n' +
  ...
  },
  {
    ...
    content:
      ...
      'Tutarlılığın bir boyutu da bilgi tutarlılığıdır. Aynı ürün hakkında bir müşteriye kalıbı normal, bir başkasına dar kesim denmişse, iki cevabı da aynı sayfada gören müşteri hangisine güveneceğini bilemez ve çoğu zaman ikisine de güvenmez. Cevaplar arasında çelişki, tek tek yanlış cevaptan bile daha yıpratıcıdır; çünkü mağazanın kendi ürününü tanımadığı izlenimini verir.\n\n' +
  ...
  },
  {
    ...
    content:
      ...
      'Bunu tek seferlik bir temizlik değil, sürekli bir döngü olarak kurmak gerekir: sorulara bak, açıklamayı güncelle, yeni gelen soruları izle, tekrar güncelle. Katalog büyüdükçe ve yeni ürünler eklendikçe eksik bilgi de yeniden birikir; döngüyü işleten satıcı, soru yükünü kalıcı olarak düşük tutar. Sezon geçişleri de bu döngünün doğal kontrol noktalarıdır; kışın kimsenin sormadığı bir bilgi, yazın en çok sorulan soru hâline gelebilir.\n\n' +
      'Nereden başlamalı? En çok soru alan ürünlerinizden. Tüm kataloğu bir günde düzeltmeye çalışmak yerine, soru yoğunluğuna göre sıralayıp en gürültülü beş-on üründen başlamak, en kısa sürede en çok etkiyi verir. Her düzenlemeden sonra o ürüne gelen soruları izleyin; aynı soru hâlâ geliyorsa bilgi ya eksiktir ya da yanlış yerdedir. Sorunun kendisi çoğu zaman düzeltmenin de tarifidir: müşteri neyi hangi kelimelerle soruyorsa, açıklamada o bilgiyi aynı kelimelerle vermek en garantili yoldur.\n\n' +
      '## Sık sorulan sorular\n\n' +
